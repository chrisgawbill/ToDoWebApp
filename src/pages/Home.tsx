...
export default function Home() {
  ...
  return (
    <Container>
      <Row>
        <Col md={8}><ToDoHolder toDoList={toDoList} infoPanelState={infoPanelState} setInfoPanelState={setInfoPanelState} setCurrentToDoItem={setCurrentToDoItem}/></Col>
        <Col md={4} style={{display:ConvertAddPanelState(infoPanelState)}}>{AddPanelWithInfo(currentToDoItem)}</Col>
      </Row>
    </Container>
  );
}
